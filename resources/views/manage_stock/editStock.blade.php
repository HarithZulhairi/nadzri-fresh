...
<div class="waste-container">
    <h1 style="text-align: center;">Edit Product To Stock Form</h1>
    @if($errors->any())
    ...
    <form id="stockForm" method="POST" action="{{ route('manage_stock.updateStock', ['product' => $product->product_ID, 'stock' => $stock->stock_ID]) }}" class="edit-form-container">
        @csrf
        @method('PUT')
        ...
        <div class="form-content">
            ...
            <div class="form-section">
                <h2>Quantity</h2>
                <div class="form-group">
                    <input type="number" id="stock_quantity" name="stock_quantity" class="form-control" value="{{ old('stock_quantity', $stock->stock_quantity) }}" required>
                </div>
            </div>
            ...
            <div class="buttons">
                <button type="button" onclick="showConfirmationModal()" class="edit-btn">Edit</button>
                <a href="{{ route('manage_stock.viewStock') }}" class="back-btn">Cancel</a>
            </div>
        </div>
    </form>
</div>
...
<div id="confirmationModal" class="confirmation-modal">
    <div class="modal-content">
        <h3 style="text-align: center;">Are you sure you want to confirm edit this product?</h3>
